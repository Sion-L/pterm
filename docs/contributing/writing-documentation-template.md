...
```markdown
    ...
    <p align="center"><a href="https://github.com/Sion-L/pterm/blob/master/_examples/template/main.go" target="_blank">(Show source of demo)</a></p>
    ...
    |--------|-----------|
    |[FunctionName](https://pkg.go.dev/github.com/Sion-L/pterm#TemplatePrinter.FunctionName)|Description of function|
    ...
    |Option|Type|
    |------|----|
    |[OptionName](https://pkg.go.dev/github.com/Sion-L/pterm#TemplatePrinter.OptionName)|[TypeName](https://pkg.go.dev/github.com/Sion-L/pterm#TypeName)|
