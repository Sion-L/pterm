...
<p align="center"><a href="https://github.com/Sion-L/pterm/blob/master/_examples/paragraph/main.go" target="_blank">(Show source of demo)</a></p>
...
| Option                                                                              | Type      |
| ----------------------------------------------------------------------------------- | --------- |
| [MaxWidth](https://pkg.go.dev/github.com/Sion-L/pterm#ParagraphPrinter.WithMaxWidth) | int       |
| [Writer](https://pkg.go.dev/github.com/Sion-L/pterm#ParagraphPrinter.WithWriter)     | io.Writer |
