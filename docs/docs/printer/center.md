...
<p align="center"><a href="https://github.com/Sion-L/pterm/blob/master/_examples/center/main.go" target="_blank">(Show source of demo)</a></p>
...
| Option                                                                                                           | Type      |
| ---------------------------------------------------------------------------------------------------------------- | --------- |
| [CenterEachLineSeparately](https://pkg.go.dev/github.com/Sion-L/pterm#CenterPrinter.WithCenterEachLineSeparately) | ...bool   |
| [Writer](https://pkg.go.dev/github.com/Sion-L/pterm#CenterPrinter.WithWriter)                                     | io.Writer |
