...
<p align="center"><a href="https://github.com/Sion-L/pterm/blob/master/_examples/print-with-color/main.go" target="_blank">(Show source of demo)</a></p>
...
|--------|-----------|
|[String](https://pkg.go.dev/github.com/Sion-L/pterm#Color.String)|String converts the color to a string.|
